...
(defvar +azy2/themes `(doom-one
                       ...
                       doom-tomorrow-night
                       doom-tomorrow-day))
(defvar +azy2/theme-index 0)

;;;###autoload
(defun +azy2/next-theme ()
  (interactive)
  (setq +azy2/theme-index (% (1+ +azy2/theme-index) (length +azy2/themes)))
  (setq doom-theme (nth +azy2/theme-index +azy2/themes))
  (doom//reload-theme))
